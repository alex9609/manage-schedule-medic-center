...
import MedicoGeneralImg from "../assets/MedicoGeneral.jpg"
...
const MedicoGeneral = () => {
    ...
    return (
        <div className="container-inicio">
            ...
            <img src={MedicoGeneralImg} alt="medico" className="medicoEspecialista" />
            <p>Seleccione el médico que desea agendar:</p>
            <div className="contenedor-grid">
                ...
                >
                    ...
                    <h3><FaHospitalUser /> Alejandro Sanabria</h3>
                ...
                >
                    <h3><FaHospitalUser /> Raul Fernandez</h3>
                    <p>Cel: 324 567 39 23</p>
                </div>
